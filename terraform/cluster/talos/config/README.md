...
| <a name="input_kubernetes_version"></a> [kubernetes\_version](#input\_kubernetes\_version) | Kubernetes version to install. Mirrors cluster/talos's default. | `string` | `"1.36.1"` | no |
